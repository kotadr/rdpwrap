...
//  URL = 'https://raw.githubusercontent.com/stascorp/rdpwrap/master/res/rdpwrap.ini';
  URL = 'https://raw.githubusercontent.com/kotadr/rdpwrap/master/res/rdpwrap.ini';
var
  NetHandle: HINTERNET;
  UrlHandle: HINTERNET;
  Str: String;
...
var
  I: Integer;
begin
  Writeln('RDP Wrapper Library v1.6.3');
  Writeln('Installer v2.7');
  Writeln('Copyright (C) Stas''M Corp. and contributors');
  Writeln('');
