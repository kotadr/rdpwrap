...
type
  TMainForm = class(TForm)
    ...
    procedure lsWrapVerClick(Sender: TObject);
...
pprocedure TMainForm.lsWrapVerClick(Sender: TObject);
begin

end;

rocedure TMainForm.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
eprocedure TMainForm.lWrapVerClick(Sender: TObject);
begin

eprocedure TMainForm.lWrapperClick(Sender: TObject);
begin
